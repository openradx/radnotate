...
export const helpStartPage = <Typography variant="body1" align={"justify"}>
    ...
    Since a few features are still missing, please contact me regarding processing the exported CSV file.<br/><br/>
    Future features:
    <ul>
        <li>Directly export all segmentations and annotation masks into DCMSEG or NIFTI files.</li>
        <li>Load images from PACS directly from Radnotate.</li>
...
export const helpAnnotationMode = <Typography variant="body1" align={"justify"}>
    ...
    You can export the annotation data table whenever you want by pressing the corresponding export button. Be sure to always export the CSV file, since it contains the maximum of information and the meta data which is necessary, to load the annotations again in future for example for validation purposes. Additionally, you can export the annotations without any meta data as XLS.<br/><br/>
    Additional information:
    <ul>
        <li> Segmentations support a correction mode, undo and redo functionality, which should be self explanatory. By pressing reset, all already made segmentations of the current variable are deleted.
        </li>
        <li>The variable types boolean and integer can be reset by pressing the escape key.
        </li>
        ...
        <li>Undo and redo functionality of segmentations can be also triggered via pressing the keys control and z resp. y.
        </li>
    ...
    <ul>
        ...
        <li>Clear the current annotation data table and all annotations by pressing the corresponding button in the settings menu.</li>
